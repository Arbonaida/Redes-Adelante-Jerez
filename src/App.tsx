...
export default function App() {
  ...
  // Electoral campaign visibility (accordion state)
  const [isCampaignOpen, setIsCampaignOpen] = useState(false);
  const [isCampaignOpenMunicipales, setIsCampaignOpenMunicipales] = useState(false);
  const [isCampaignOpenGenerales, setIsCampaignOpenGenerales] = useState(false);
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 font-work antialiased selection:bg-[#24C87F] selection:text-white pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center space-x-2 font-clash text-2xl tracking-tight text-slate-900 select-none">
              <span className="bg-brand-green font-bold text-white px-2.5 py-1 rounded-xl shadow-md border border-brand-green/20">Adelante</span>
          ...
          <div className="flex items-center gap-6">
            <div className="hidden lg:flex items-center gap-6 text-xs font-bold uppercase tracking-wider text-slate-500">
              ...
              <a href="#applications" className="hover:text-brand-green transition-colors flex items-center gap-1">
                <span className="w-1.5 h-1.5 rounded-full bg-brand-green animate-pulse"></span>
                Aplicaciones
              </a>
              <a href="#campaign" className="hover:text-brand-green transition-colors">Campaña</a>
            ...
            <div className="flex lg:hidden items-center gap-3 text-[10px] font-bold uppercase tracking-wider text-slate-500 overflow-x-auto max-w-[150px] sm:max-w-xs md:max-w-md whitespace-nowrap py-1">
              ...
              <a href="#video" className="hover:text-brand-green transition-colors">Vídeo</a>
              <a href="#applications" className="hover:text-brand-green transition-colors">Apps</a>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-clash font-bold tracking-tight mb-3 leading-tight text-white">
              Manual de Marca <span className="text-emerald-100">Adelante Andalucía</span>
            </h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 sm:mt-16 space-y-12 sm:space-y-16">
        ...
        <section id="video" className="scroll-mt-24 bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden p-6 sm:p-8 lg:p-10">
          ...
          <div className="mb-8">
            <a
              href="https://drive.google.com/drive/u/0/folders/1nHZ57WQiNYLW0fqmRrUYd90bzrobPrNt"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="space-y-8">
            ...
            {/* Custom Request (Petición Personalizada) & Action Buttons Banner */}
            <div className="bg-[#24C87F]/10 p-6 sm:p-8 rounded-3xl border border-[#24C87F]/20 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
              <div className="space-y-1.5 max-w-2xl">
                ...
                <h4 className="font-clash font-bold text-lg text-slate-900">¿Faltan letreros de tu asamblea?</h4>
                <p className="text-slate-600 text-xs leading-relaxed">
                  Si eres una asamblea local y produces contenido audiovisual de manera regular, solicita la creación de letreros corporativos personalizados escribiendo a <strong className="text-slate-800 font-bold">adelanteandalucia@gmail.com</strong>.
                </p>
              </div>

              <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto shrink-0">
                <a
                  href="https://canva.link/xm79fkz1fz7wrwu"
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-100 text-slate-700 border border-slate-200 font-bold text-xs uppercase tracking-wider py-3 px-5 rounded-xl shadow-sm transition-colors cursor-pointer w-full sm:w-auto text-center"
                >
        ...
        {/* SECTION 5: Aplicaciones de Marca */}
        <section id="applications" className="scroll-mt-24 bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden p-6 sm:p-8 lg:p-10 relative">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#24C87F]/10 rounded-full blur-3xl -translate-y-12 translate-x-12"></div>
          ...
          <div className="relative z-10 space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="text-xs font-bold font-montserrat uppercase tracking-wider text-brand-green">Ecosistema Satélite</span>
                <h2 className="text-2xl sm:text-3xl font-clash font-bold tracking-tight text-slate-900">Aplicaciones de Marca</h2>
              </div>
            </div>

            <p className="text-slate-600 text-sm max-w-3xl leading-relaxed">
              Herramientas de automatización y creación de contenidos diseñadas específicamente para unificar la marca gráfica de Adelante Andalucía y dar soporte a toda la militancia y asambleas locales.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* App 1: Firmas de Correo */}
              <div className="group bg-slate-50 rounded-2xl border border-slate-200 p-5 flex flex-col justify-between hover:border-[#24C87F]/50 hover:shadow-[0_0_25px_rgba(36,200,127,0.1)] hover:-translate-y-1 transition-all duration-300">
                <div>
                  <div className="h-12 w-12 bg-[#24C87F]/10 rounded-xl mb-4 flex items-center justify-center text-2xl group-hover:bg-[#24C87F]/20 transition-all duration-300">
                    📧
                  </div>
                  <h3 className="font-clash font-bold text-base text-slate-800 mb-2">Generador de Firmas de Correo</h3>
                  <p className="text-slate-600 text-xs leading-relaxed mb-4">
                    Crea tu firma oficial corporativa de correo electrónico en segundos. Introduce tus datos, copia el resultado y pégalo directamente en tu cliente de correo preferido.
                  </p>
                </div>
                <a
                  href="https://ai.studio/apps/fb824371-1e0e-4767-93cb-a85c20b96d13?fullscreenApplet=true"
                  target="_blank"
                  rel="noreferrer"
                  className="mt-2 inline-flex items-center justify-center gap-1.5 w-full bg-[#24C87F] hover:bg-[#1fb873] text-white py-2.5 px-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-200 cursor-pointer"
                >
                  Abrir Aplicación
                  <ExternalLink className="w-3.5 h-3.5" />
                </a>
              ...
              {/* App 2: Creador de Mapas */}
              <div className="group bg-slate-50 rounded-2xl border border-slate-200 p-5 flex flex-col justify-between hover:border-[#24C87F]/50 hover:shadow-[0_0_25px_rgba(36,200,127,0.1)] hover:-translate-y-1 transition-all duration-300">
                <div>
                  <div className="h-12 w-12 bg-[#24C87F]/10 rounded-xl mb-4 flex items-center justify-center text-2xl group-hover:bg-[#24C87F]/20 transition-all duration-300">
                    🗺️
                  </div>
                  <h3 className="font-clash font-bold text-base text-slate-800 mb-2">Generador de Mapas para Vídeos</h3>
                  <p className="text-slate-600 text-xs leading-relaxed mb-4">
                    Genera mapas geolocalizados animados con estéticas unificadas y marcas dinámicas personalizados para recortar e integrar en tus clips y contenidos de vídeo.
                  </p>
                </div>
                <a
                  href="https://ai.studio/apps/ccd9efa8-530a-472a-8a50-9110f73430c0?fullscreenApplet=true"
                  target="_blank"
                  rel="noreferrer"
                  className="mt-2 inline-flex items-center justify-center gap-1.5 w-full bg-[#24C87F] hover:bg-[#1fb873] text-white py-2.5 px-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-200 cursor-pointer"
                >
              ...
              {/* Placeholder 1 */}
              <div className="bg-slate-50/50 rounded-2xl border border-dashed border-slate-200 p-5 flex flex-col justify-between min-h-[220px]">
                <div className="flex-grow flex flex-col justify-center items-center text-center p-4">
                  <div className="h-10 w-10 rounded-full border border-dashed border-slate-300 flex items-center justify-center text-slate-400 text-lg mb-3">
                    +
                  </div>
                  <span className="font-clash font-semibold text-slate-500 text-xs">Nueva Aplicación Próximamente</span>
                  <p className="text-slate-400 text-[11px] mt-1">
                    Próximamente disponible para las asambleas locales de toda Andalucía.
                  </p>
                </div>
                <div className="py-2 px-3 text-center bg-slate-100/80 rounded-xl text-[10px] uppercase tracking-wider font-bold text-slate-400">
                  Próximamente
                </div>
              </div>
        ...
        {/* SECTION 6: ELECTORAL CAMPAIGN (ACCORDION DEPLEGABLE - CLOSED BY DEFAULT) */}
        <section id="campaign" className="scroll-mt-24 space-y-6">
          
          {/* Autonómicas 2026 Box */}
          <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden">
            {/* Header of Accordion */}
            <button
              onClick={() => setIsCampaignOpen(!isCampaignOpen)}
              className="w-full flex items-center justify-between p-6 sm:p-8 lg:p-10 cursor-pointer text-left bg-slate-50/50 hover:bg-slate-50 transition-colors focus:outline-none"
              aria-expanded={isCampaignOpen}
            >
              <div className="flex items-start gap-4">
                <div className={`p-3 rounded-2xl border transition-colors ${isCampaignOpen ? 'bg-[#24C87F] border-[#24C87F]/30 text-white' : 'bg-[#24C87F]/10 border-[#24C87F]/10 text-[#24C87F]'}`}>
                  <Megaphone className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-xs font-bold font-montserrat uppercase tracking-wider text-slate-500">Zona de Campaña</span>
                  <h2 className="text-2xl sm:text-3xl font-clash font-bold tracking-tight text-slate-900 flex items-center gap-2.5">
                    Elecciones Autonómicas 2026
                    <span className="text-xs font-bold font-work uppercase bg-emerald-50 border border-emerald-200 text-emerald-700 px-2.5 py-0.5 rounded-full inline-block">
                      Disponible
                    </span>
                  </h2>
                  <p className="text-slate-500 text-xs sm:text-sm mt-1">
                    Haz click para desplegar y acceder a los carteles oficiales, pegatinas y croquis de impresión.
                  </p>
                </div>
              </div>

              <div className="bg-white p-2.5 rounded-xl border border-slate-200 shadow-md text-slate-500 hover:text-slate-900 transition-colors ml-4 flex-shrink-0">
                {isCampaignOpen ? (
          ...
          <AnimatePresence initial={false}>
            {isCampaignOpen && (
              ...
              >
                <div className="p-6 sm:p-8 lg:p-10 bg-white space-y-10">
                  
                  {/* WARNING: Embargo Info */}
                  <div className="bg-red-50 text-red-900 rounded-2xl p-5 sm:p-6 flex flex-col sm:flex-row items-center gap-5 border border-red-200 shadow-sm">
                    <div className="bg-red-100 text-red-600 border border-red-200 p-3.5 rounded-xl text-3xl font-bold select-none animate-bounce">
                      🛑
                    </div>
                    <div className="space-y-1 flex-grow text-center sm:text-left">
                      <h3 className="font-clash font-extrabold text-xl text-red-600 uppercase tracking-wide">
                        ADVERTENCIA ANTI-MULTAS (EMBARGO)
                      </h3>
                      <p className="text-slate-700 text-sm font-semibold">
                        Este material está estrictamente <span className="text-red-600 font-bold underline">embargado</span>. Está totalmente prohibida su difusión pública (tanto en redes sociales como pegada física en la calle) antes de la fecha límite establecida.
                      </p>
                    </div>
                  </div>

                  {/* Proportions & Print Spec Chart */}
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    
                    {/* Interative Visual Proportions croquis */}
                    <div className="lg:col-span-7 bg-slate-50 rounded-2xl border border-slate-200 p-6 space-y-6">
                      <div>
                        <span className="text-[10px] font-bold font-montserrat uppercase tracking-wider text-brand-green">Guía Gráfica</span>
                        <h4 className="font-clash font-bold text-lg text-slate-900 mb-1">Croquis de Proporciones ISO</h4>
                        <p className="text-slate-500 text-xs leading-relaxed">
                          Visualización a escala del formato para cartelería. Pasa el cursor sobre los bloques para comparar sus tamaños relativos de impresión.
                        </p>
                      </div>

                      {/* Interactive Visual Canvas */}
                      <div className="h-64 bg-slate-100/80 rounded-xl border border-slate-200 p-4 flex items-end justify-start gap-1.5 overflow-x-auto relative">
                        {SIZE_SPECIFICATIONS.map((size) => (
                          <div
                            key={size.label}
                            onMouseEnter={() => setHoveredSize(size.label)}
                            onMouseLeave={() => setHoveredSize(null)}
                            className={`rounded-lg p-2 flex flex-col justify-between text-[#0c0c0c] font-clash font-bold text-xs cursor-help transition-all duration-200 shrink-0 ${size.color} ${
                              hoveredSize === size.label ? 'ring-4 ring-[#24C87F] ring-offset-2 scale-105 z-10' : 'opacity-85 hover:opacity-100'
                            }`}
                            style={{
                              width: size.label === 'A1' ? '120px' : size.label === 'A2' ? '100px' : size.label === 'A3' ? '80px' : size.label === 'A4' ? '65px' : size.label === 'A5' ? '55px' : '45px',
                              height: size.label === 'A1' ? '100%' : size.label === 'A2' ? '85%' : size.label === 'A3' ? '70%' : size.label === 'A4' ? '55%' : size.label === 'A5' ? '40%' : '28%'
                            }}
                          >
                            <span className="text-sm">{size.label}</span>
                            {hoveredSize === size.label && (
                              <motion.span
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                className="text-[8px] font-work font-bold tracking-tight text-[#0c0c0c] leading-none block truncate"
                              >
                                {size.dimensions}
                              </motion.span>
                            )}
                        ...
                        {/* Visual info label */}
                        <div className="absolute top-2 right-2 bg-white border border-slate-200 px-2 py-1 rounded text-[9px] text-slate-500 font-bold uppercase shadow-xs">
                          {hoveredSize ? `Foco: Formato ${hoveredSize}` : 'Pasa el cursor para medidas'}
                        </div>
                      </div>

                      {/* Dimensions Info List */}
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {SIZE_SPECIFICATIONS.map((size) => (
                          <div
                            key={size.label}
                            className={`p-2 rounded-xl border transition-colors ${
                              hoveredSize === size.label ? 'bg-[#24C87F]/10 border-[#24C87F]/30' : 'bg-white border-slate-200'
                            }`}
                          >
                            <span className="font-clash font-bold text-xs text-slate-900 block">{size.label}</span>
                            <span className="font-mono text-[10px] text-slate-500 block">{size.dimensions}</span>
                            <span className="text-[9px] font-bold text-slate-400 block mt-0.5 uppercase tracking-tighter">{size.relative}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    {/* Print notes block */}
                    <div className="lg:col-span-5 bg-slate-50 rounded-2xl border border-slate-200 p-6 flex flex-col justify-between h-full space-y-6">
                      <div className="space-y-4">
                        <div className="flex items-center gap-2">
                          <Info className="text-brand-green w-5 h-5" />
                          <h4 className="font-clash font-bold text-base text-slate-900">Directrices de Impresión</h4>
                        </div>
                        
                        <div className="space-y-3.5 text-slate-600 text-xs leading-relaxed">
                          <p>
                            <strong className="text-slate-800 block">✔️ Papel Mate para Encolar:</strong>
                            Para las pegadas de carteles en la calle utilizando cola, es imprescindible ordenar la impresión en <strong className="text-slate-800">papel MATE</strong> (no satinado o brillo). El papel mate absorbe correctamente la cola, evita que surjan arrugas rebeldes y no produce reflejos que impidan leer el texto en días soleados.
                          </p>
                          <p>
                            <strong className="text-slate-800 block">✔️ Pegatinas (A6):</strong>
                            Ideales para reparto masivo. Se descargan preparadas con marcas de corte estándar para la imprenta.
                          </p>
                          <p>
                            <strong className="text-slate-800 block">✔️ Díptico Folleto:</strong>
                            Preparado en formato de dos cuerpos (díptico plegable) con margen de sangrado para asegurar un acabado óptimo en imprentas locales.
                          </p>
                        </div>
                      </div>

                      <div className="p-3.5 bg-white border border-slate-200 rounded-xl text-center shadow-xs">
                        <span className="font-bold text-slate-700 text-xs block">¿Necesitas otros tamaños específicos?</span>
                        <span className="text-slate-500 text-[11px] block mt-0.5">Escribe al equipo de soporte para redimensionar carteles.</span>
                      </div>
                    </div>
                  ...
                  <div>
                    <h4 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4 block">Catálogo de Materiales descargables</h4>
                    
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                      {CAMPAIGN_ASSETS.map((asset) => (
                        <div
                          key={asset.id}
                          className="bg-slate-50 rounded-2xl border border-slate-200/60 p-5 flex flex-col justify-between hover:border-[#24C87F]/40 hover:bg-white hover:shadow-lg transition-all duration-300 min-h-[170px]"
                        >
                          <div>
                            <span className="text-[9px] font-bold text-[#24C87F] bg-[#24C87F]/10 px-2 py-0.5 rounded-full border border-[#24C87F]/20 uppercase tracking-wider block mb-1 self-start inline-block">
                              {asset.format}
                            </span>
                            <h5 className="font-clash font-bold text-base text-slate-800 mt-2 mb-1">
                              {asset.name}
                            </h5>
                          </div>
                            ...
                            {asset.link !== '#' ? (
                              <>
                                ...
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="inline-flex items-center gap-1 bg-[#24C87F] hover:bg-[#1fb873] text-white font-bold text-xs uppercase px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
                                >
                                  Bajar
                              ...
                              <>
                                ...
                                <button
                                  disabled
                                  className="opacity-50 inline-flex items-center gap-1 bg-slate-100 text-slate-400 font-bold text-xs uppercase px-3 py-1.5 rounded-lg cursor-not-allowed"
                                >
                                  Bajar
                                </button>
                              </>
          ...
          {/* Elecciones Municipales 2027 Box */}
          <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden">
            {/* Header of Accordion */}
            <button
              onClick={() => setIsCampaignOpenMunicipales(!isCampaignOpenMunicipales)}
              className="w-full flex items-center justify-between p-6 sm:p-8 lg:p-10 cursor-pointer text-left bg-slate-50/50 hover:bg-slate-50 transition-colors focus:outline-none"
              aria-expanded={isCampaignOpenMunicipales}
            >
              <div className="flex items-start gap-4">
                <div className={`p-3 rounded-2xl border transition-colors ${isCampaignOpenMunicipales ? 'bg-slate-400 border-slate-400/30 text-white' : 'bg-slate-100 border-slate-200 text-slate-400'}`}>
                  <Megaphone className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-xs font-bold font-montserrat uppercase tracking-wider text-slate-400">Zona de Campaña</span>
                  <h2 className="text-2xl sm:text-3xl font-clash font-bold tracking-tight text-slate-400 flex items-center gap-2.5">
                    Elecciones Municipales 2027
                    <span className="text-xs font-bold font-work uppercase bg-slate-100 border border-slate-200 text-slate-400 px-2.5 py-0.5 rounded-full inline-block">
                      Planificado
                    </span>
                  </h2>
                  <p className="text-slate-400 text-xs sm:text-sm mt-1">
                    Diseños y directrices en fase de preparación para los comicios locales de toda Andalucía.
                  </p>
                </div>
              </div>

              <div className="bg-white p-2.5 rounded-xl border border-slate-200 shadow-md text-slate-400 hover:text-slate-600 transition-colors ml-4 flex-shrink-0">
                {isCampaignOpenMunicipales ? (
                  <ChevronUp className="w-5 h-5 stroke-[2.5]" />
                ) : (
                  <ChevronDown className="w-5 h-5 stroke-[2.5]" />
                )}
            ...
            <AnimatePresence initial={false}>
              {isCampaignOpenMunicipales && (
                <motion.div
                  ...
                  className="overflow-hidden border-t border-slate-200"
                >
                  <div className="p-6 sm:p-8 lg:p-10 bg-slate-50/30 space-y-10 opacity-60 pointer-events-none select-none grayscale">
                    
                    {/* LOCK INFO */}
                    <div className="bg-slate-100 text-slate-700 rounded-2xl p-5 sm:p-6 flex flex-col sm:flex-row items-center gap-5 border border-slate-200 shadow-sm">
                      <div className="bg-white text-slate-500 border border-slate-200 p-3.5 rounded-xl text-3xl font-bold select-none">
                        🔒
                      </div>
                      <div className="space-y-1 flex-grow text-center sm:text-left">
                        <h3 className="font-clash font-extrabold text-xl text-slate-600 uppercase tracking-wide">
                          MATERIAL EN PLANIFICACIÓN
                        </h3>
                        <p className="text-slate-500 text-sm font-semibold font-work">
                          Este espacio se activará al iniciarse oficialmente el diseño de la campaña de 2027. Actualmente no hay recursos descargables.
                        </p>
                      </div>
                    </div>

                    {/* Proportions & Print Spec Chart (Muted/Locked) */}
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                      
                      {/* Interactive Visual Proportions croquis */}
                      <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-200 p-6 space-y-6">
                        <div>
                          <span className="text-[10px] font-bold font-montserrat uppercase tracking-wider text-slate-400">Guía Gráfica</span>
                          <h4 className="font-clash font-bold text-lg text-slate-400 mb-1">Croquis de Proporciones ISO</h4>
                          <p className="text-slate-400 text-xs leading-relaxed">
                            Visualización a escala del formato para cartelería. (Desactivado)
                          </p>
                        </div>

                        {/* Interactive Visual Canvas */}
                        <div className="h-64 bg-slate-100 rounded-xl border border-slate-200 p-4 flex items-end justify-start gap-1.5 overflow-x-auto relative">
                          {SIZE_SPECIFICATIONS.map((size) => (
                            <div
                              key={size.label}
                              className={`rounded-lg p-2 flex flex-col justify-between text-slate-400 font-clash font-bold text-xs bg-slate-200/50 shrink-0`}
                              style={{
                                width: size.label === 'A1' ? '120px' : size.label === 'A2' ? '100px' : size.label === 'A3' ? '80px' : size.label === 'A4' ? '65px' : size.label === 'A5' ? '55px' : '45px',
                                height: size.label === 'A1' ? '100%' : size.label === 'A2' ? '85%' : size.label === 'A3' ? '70%' : size.label === 'A4' ? '55%' : size.label === 'A5' ? '40%' : '28%'
                              }}
                      ...
                      {/* Print notes block */}
                      <div className="lg:col-span-5 bg-white rounded-2xl border border-slate-200 p-6 flex flex-col justify-between h-full space-y-6">
                        <div className="space-y-4">
                          <div className="flex items-center gap-2 text-slate-400">
                            <Info className="w-5 h-5" />
                            <h4 className="font-clash font-bold text-base">Directrices de Impresión</h4>
                          </div>
                          <p className="text-slate-400 text-xs leading-relaxed font-work">
                            Las directrices técnicas de impresión se publicarán junto con los diseños de la campaña de 2027.
                          </p>
                        </div>
                      </div>
                    ...
                    {/* Campaign Assets grid */}
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4 block">Catálogo de Materiales descargables</h4>
                      
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {CAMPAIGN_ASSETS.map((asset) => (
                          <div
                            key={asset.id}
                            className="bg-white rounded-2xl border border-slate-100 p-5 flex flex-col justify-between min-h-[170px]"
                          >
                            <div>
                              <span className="text-[9px] font-bold text-slate-400 bg-slate-100 px-2 py-0.5 rounded-full border border-slate-200 uppercase tracking-wider block mb-1 self-start inline-block">
                                {asset.format}
                              </span>
                              <h5 className="font-clash font-bold text-base text-slate-400 mt-2 mb-1">
                                {asset.name}
                              </h5>
                            </div>
                            ...
                            <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between gap-2">
                              ...
                              <button
                                disabled
                                className="bg-slate-100 text-slate-400 font-bold text-xs uppercase px-3 py-1.5 rounded-lg cursor-not-allowed"
                              >
                                Bloqueado
                              </button>
                            </div>
          ...
          {/* Elecciones Generales ¿2027? Box */}
          <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden">
            {/* Header of Accordion */}
            <button
              onClick={() => setIsCampaignOpenGenerales(!isCampaignOpenGenerales)}
              className="w-full flex items-center justify-between p-6 sm:p-8 lg:p-10 cursor-pointer text-left bg-slate-50/50 hover:bg-slate-50 transition-colors focus:outline-none"
              aria-expanded={isCampaignOpenGenerales}
            >
              <div className="flex items-start gap-4">
                <div className={`p-3 rounded-2xl border transition-colors ${isCampaignOpenGenerales ? 'bg-slate-400 border-slate-400/30 text-white' : 'bg-slate-100 border-slate-200 text-slate-400'}`}>
                  <Megaphone className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-xs font-bold font-montserrat uppercase tracking-wider text-slate-400">Zona de Campaña</span>
                  ...
                  <p className="text-slate-400 text-xs sm:text-sm mt-1">
                    Preparación previa de materiales de identidad nacional para la asamblea general.
                  </p>
                </div>
              </div>

              <div className="bg-white p-2.5 rounded-xl border border-slate-200 shadow-md text-slate-400 hover:text-slate-600 transition-colors ml-4 flex-shrink-0">
                {isCampaignOpenGenerales ? (
                  <ChevronUp className="w-5 h-5 stroke-[2.5]" />
                ) : (
                  <ChevronDown className="w-5 h-5 stroke-[2.5]" />
                )}
                  ...
                  <div className="p-6 sm:p-8 lg:p-10 bg-slate-50/30 space-y-10 opacity-60 pointer-events-none select-none grayscale">
                    ...
                    <div className="bg-slate-100 text-slate-700 rounded-2xl p-5 sm:p-6 flex flex-col sm:flex-row items-center gap-5 border border-slate-200 shadow-sm">
                      ...
                      <div className="space-y-1 flex-grow text-center sm:text-left">
                        ...
                        <p className="text-slate-500 text-sm font-semibold font-work">
                          Este espacio se activará al convocarse oficialmente las Elecciones Generales. Actualmente no hay recursos descargables.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                      ...
                      <div className="lg:col-span-5 bg-white rounded-2xl border border-slate-200 p-6 flex flex-col justify-between h-full space-y-6">
                        <div className="space-y-4">
                          ...
                          <p className="text-slate-400 text-xs leading-relaxed font-work">
                            Las directrices técnicas de impresión se publicarán junto con los diseños oficiales de la campaña.
                          </p>
                        </div>
                      </div>
        ...
        <section id="support" className="scroll-mt-24 bg-gradient-to-br from-slate-50 to-slate-100/60 border border-[#24C87F]/30 text-slate-800 rounded-3xl p-6 sm:p-8 lg:p-10 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-slate-600 text-sm max-w-xl leading-relaxed font-medium">
                  Soy <strong className="text-slate-900 font-bold">Pepe</strong>, encargado de coordinar los materiales de diseño para Adelante Andalucía. Si encuentras algún enlace roto, o requieres asesoramiento, ¡estoy disponible!
                </p>
              </div>
            </div>

            <a
              href="https://t.me/+34673040233"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              Contactar con Pepe por Telegram
            </a>
          </div>
        </section>
      ...
      <footer className="mt-20 border-t border-slate-200 bg-slate-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-2 font-clash text-lg text-slate-800">
            <span className="bg-[#24C87F]/20 text-[#24C87F] font-bold px-2.5 py-0.5 rounded-lg border border-[#24C87F]/10">Adelante</span>
            <span className="text-brand-green font-light">marca</span>
          </div>
